          ...
          >
            ...
            <Box>
              <Typography sx={{
                ...
                fontSize: '1.25rem', color: '#c8a96e', lineHeight: 1, letterSpacing: '0.05em',
              }}>
                NEXTGEN
              </Typography>
              <Typography sx={{
                fontFamily: '"DM Sans", sans-serif', fontSize: '0.6rem',
                color: '#9db8a8', letterSpacing: '0.2em', lineHeight: 1,
              }}>
                LIBRARY SYSTEM
              </Typography>
            </Box>
              ...
              return (
                <Button
                  ...
                  sx={{
                    ...
                    transition: 'all 0.2s',
                    '&:hover': {
                      bgcolor: 'rgba(200,169,110,0.08)', color: '#c8a96e',
            ...
            {user ? (
              <>
                <Box sx={{
                  ...
                  {isAdmin && (
                    <Box sx={{
                      ...
                      bgcolor: 'rgba(200,169,110,0.2)', fontSize: '0.6rem',
                ...
                <Button
                  ...
                  startIcon={<LockIcon sx={{ fontSize: '1rem !important' }} />}
                  sx={{
                    color: '#9db8a8', fontFamily: '"DM Sans", sans-serif',
                    fontSize: '0.85rem',
                    border: '1px solid rgba(157,184,168,0.2)', borderRadius: '8px', px: 2,
                    '&:hover': { bgcolor: 'rgba(200,169,110,0.08)', borderColor: 'rgba(200,169,110,0.2)', color: '#c8a96e' },
                    transition: 'all 0.2s',
                  }}
                >
                  Password
                ...
                <Button
                  ...
                  sx={{
                    color: '#9db8a8', fontFamily: '"DM Sans", sans-serif', fontSize: '0.85rem',
                    border: '1px solid rgba(157,184,168,0.2)', borderRadius: '8px', px: 2,
                    '&:hover': {
                      bgcolor: 'rgba(248,113,113,0.08)', borderColor: 'rgba(248,113,113,0.3)', color: '#f87171',
                    },
                    transition: 'all 0.2s',
                  }}
                >
              ...
              <Button
                ...
                sx={{
                  background: 'linear-gradient(135deg, #c8a96e, #a07840)',
                  color: '#0d1f17', fontWeight: 700,
                  fontFamily: '"DM Sans", sans-serif', borderRadius: '8px', px: 3,
                  '&:hover': { background: 'linear-gradient(135deg, #e2c98f, #c8a96e)' },
                }}
              >
                Sign In
              </Button>
